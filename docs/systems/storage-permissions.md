...
sources:
  - id: quickbytes
    ...
    last_modified: "2026-08-03T15:31:44-06:00"
---
...
<p class="carc-provenance" markdown>Migrated from [UNM-CARC QuickBytes](https://github.com/UNM-CARC/QuickBytes/blob/master/storage_permissions_BeeGFS.md){target=_blank} (last source update 2026-08-03). Spotted a problem? [Open an issue or pull request](https://github.com/UNM-CARC/QuickBytes){target=_blank}.</p>
