...
sources:
  - id: quickbytes
    ...
    last_modified: "2026-07-29T11:54:59-06:00"
---
...
<p class="carc-provenance" markdown>Migrated from [UNM-CARC QuickBytes](https://github.com/UNM-CARC/QuickBytes/blob/master/anaconda_pip_channels.md){target=_blank} (last source update 2026-07-29). Spotted a problem? [Open an issue or pull request](https://github.com/UNM-CARC/QuickBytes){target=_blank}.</p>
